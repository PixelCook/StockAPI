...
async function resultsLoad(event){
    ...
    if (response.ok){
        ...
        for(i=0; i<result.length; i++) {
            ...
            <a href='company.html?symbol=${result[i].symbol}'><img src='https://financialmodelingprep.com/image-stock/${result[i].symbol}.png' onerror="this.onerror=null;this.src='https://financialmodelingprep.com/image-stock/PEER.jpg'">${result[i].name}(${result[i].symbol})</a>
            <li>`
        }
    }else {
        console.log(`error`)
